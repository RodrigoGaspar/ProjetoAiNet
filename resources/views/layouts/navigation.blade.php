...
=======
            @if(!auth()->check() || (auth()->check() && auth()->user()->type == 'C'))
                <div class="hidden sm:flex sm:ms-60">
                    <x-nav-link :href="route('cart.show')" :active="request()->routeIs('')">
                        {{ __('Cart') }}
                    </x-nav-link>
                </div>
            @endif
>>>>>>> Stashed changes
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800 dark:text-gray-200">@isset( Auth::user()->name ) @endisset</div>
                <div class="font-medium text-sm text-gray-500">@isset( Auth::user()->email ) @endisset</div>
            </div>
